...
<body style="background:url(https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1594926213441&di=f468571e50078ce61ea4b5694b764a6d&imgtype=0&src=http%3A%2F%2Fimg3.imgtn.bdimg.com%2Fit%2Fu%3D284606533%2C1943123054%26fm%3D214%26gp%3D0.jpg) ; background-size:100% 100% ; background-attachment: fixed">
...
<div class="row">
  ...
  <div class="col-md-9 col-xs-12" style="font-size: normal;color: #006400;"><p>小提示:<br>鼓励将可回收物卖入废品回收系统，或交投至两融合服务点，或投放至可回收物收集容器；<br>严禁将有害垃圾投放到其他的生活垃圾收集容器；<br>日常家庭生活垃圾要做到干、湿垃圾两分开。</p></div>
</div>
...
<footer class="bs-docs-footer">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-1 col-xs-0"></div>
      <div class="col-md-9 col-xs-12" style="color:#2FA858">
       <h3><a href="/RubbishCategory/system/login" target="_blank">登录后台</a> </h3>
      </div>
    </div>
    <div class="row">
      <div class="col-md-1 col-xs-0"></div>
